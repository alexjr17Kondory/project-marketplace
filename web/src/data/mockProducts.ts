...
export const mockProducts: Product[] = [
  // ============= ROPA SUBLIMABLE =============
  {
    ...
    colors: [
      { id: 1, name: 'Blanco', slug: 'blanco', hexCode: '#FFFFFF' },
      { id: 2, name: 'Negro', slug: 'negro', hexCode: '#000000' },
      { id: 3, name: 'Gris', slug: 'gris', hexCode: '#9CA3AF' },
    ],
  ...
  },
  {
    ...
    colors: [
      { id: 1, name: 'Blanco', slug: 'blanco', hexCode: '#FFFFFF' },
      { id: 4, name: 'Gris Claro', slug: 'gris-claro', hexCode: '#D1D5DB' },
    ],
    sizes: ['S', 'M', 'L', 'XL', 'XXL'],
    featured: true,
    stock: 85,
  ...
  },
  {
    ...
    colors: [
      { id: 1, name: 'Blanco', slug: 'blanco', hexCode: '#FFFFFF' },
      { id: 5, name: 'Gris Melange', slug: 'gris-melange', hexCode: '#9CA3AF' },
    ],
    sizes: ['S', 'M', 'L', 'XL', 'XXL'],
    featured: true,
    stock: 70,
  ...
  },
  {
    ...
    colors: [
      { id: 1, name: 'Blanco', slug: 'blanco', hexCode: '#FFFFFF' },
      { id: 6, name: 'Azul Claro', slug: 'azul-claro', hexCode: '#93C5FD' },
    ],
    sizes: ['S', 'M', 'L', 'XL', 'XXL'],
    featured: false,
    stock: 100,
  ...
  },
  {
    ...
    colors: [
      { id: 7, name: 'Blanco/Negro', slug: 'blanco-negro', hexCode: '#FFFFFF' },
      { id: 8, name: 'Blanco/Azul', slug: 'blanco-azul', hexCode: '#FFFFFF' },
      { id: 9, name: 'Blanco/Rojo', slug: 'blanco-rojo', hexCode: '#FFFFFF' },
    ],
    sizes: ['Única'],
    featured: true,
    stock: 200,
  ...
  // ============= DRINKWARE =============
  {
    ...
    colors: [
      { id: 1, name: 'Blanco', slug: 'blanco', hexCode: '#FFFFFF' },
      { id: 10, name: 'Interior Rojo', slug: 'interior-rojo', hexCode: '#DC2626' },
      { id: 11, name: 'Interior Azul', slug: 'interior-azul', hexCode: '#2563EB' },
      { id: 12, name: 'Interior Negro', slug: 'interior-negro', hexCode: '#000000' },
    ],
    sizes: ['11oz', '15oz'],
    featured: true,
    stock: 300,
  ...
  },
  {
    ...
    colors: [
      { id: 13, name: 'Negro Mágico', slug: 'negro-magico', hexCode: '#000000' },
    ],
    sizes: ['11oz'],
    featured: true,
    stock: 150,
  ...
  },
  {
    ...
    colors: [
      { id: 1, name: 'Blanco', slug: 'blanco', hexCode: '#FFFFFF' },
      { id: 14, name: 'Plateado', slug: 'plateado', hexCode: '#C0C0C0' },
    ],
  ...
  },
  {
    ...
    colors: [
      { id: 1, name: 'Blanco', slug: 'blanco', hexCode: '#FFFFFF' },
      { id: 15, name: 'Negro', slug: 'negro', hexCode: '#1F2937' },
    ],
    sizes: ['20oz', '30oz'],
    featured: false,
    stock: 90,
  ...
  // ============= HOGAR Y DECORACIÓN =============
  {
    ...
    colors: [
      { id: 16, name: 'Aluminio Brillante', slug: 'aluminio-brillante', hexCode: '#E5E7EB' },
      { id: 17, name: 'Aluminio Mate', slug: 'aluminio-mate', hexCode: '#D1D5DB' },
    ],
  ...
  },
  {
    ...
    colors: [
      { id: 18, name: 'Cuadrado', slug: 'cuadrado', hexCode: '#FFFFFF' },
      { id: 19, name: 'Redondo', slug: 'redondo', hexCode: '#FFFFFF' },
    ],
    sizes: ['Set x4', 'Set x6'],
    featured: true,
    stock: 150,
  ...
  },
  {
    ...
    colors: [
      { id: 20, name: 'Cartón Premium', slug: 'carton-premium', hexCode: '#F5F5F4' },
    ],
  ...
  // ============= ACCESORIOS =============
  {
    ...
    colors: [
      { id: 21, name: 'MDF Natural', slug: 'mdf-natural', hexCode: '#D4A574' },
    ],
  ...
  },
  {
    ...
    colors: [
      { id: 1, name: 'Blanco', slug: 'blanco', hexCode: '#FFFFFF' },
      { id: 22, name: 'Transparente', slug: 'transparente', hexCode: '#F3F4F6' },
    ],
  ...
  // ============= MÁS PRODUCTOS POPULARES =============
  {
    ...
    colors: [
      { id: 1, name: 'Blanco', slug: 'blanco', hexCode: '#FFFFFF' },
      { id: 23, name: 'Amarillo', slug: 'amarillo', hexCode: '#FDE047' },
      { id: 24, name: 'Verde Neón', slug: 'verde-neon', hexCode: '#4ADE80' },
    ],
    sizes: ['S', 'M', 'L', 'XL', 'XXL'],
    featured: true,
    stock: 180,
  ...
  },
  {
    ...
    colors: [
      { id: 1, name: 'Blanco', slug: 'blanco', hexCode: '#FFFFFF' },
      { id: 25, name: 'Beige', slug: 'beige', hexCode: '#D4B896' },
    ],
    sizes: ['Única'],
    featured: false,
    stock: 150,
  ...
  },
  {
    ...
    colors: [
      { id: 26, name: 'Blanco Set', slug: 'blanco-set', hexCode: '#FFFFFF' },
    ],
    sizes: ['Set x2 (11oz)'],
    featured: true,
    stock: 100,
